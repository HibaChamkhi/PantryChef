...
<table>
  ...
  <tr>
    <td align="center" width="33%"><img src="docs/screenshots/04-dish-scan-meal.png" width="230" alt="Dish scan" /><br /><b>Name a dish from a photo</b><br /><sub>Snap a meal you loved and PantryChef names it, lists its key ingredients and writes a recipe to make it at home, with what you already have marked.</sub></td>
