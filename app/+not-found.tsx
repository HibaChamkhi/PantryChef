...
export default function NotFoundScreen() {
  return (
    <View className="flex-1 items-center justify-center bg-cream-50 px-8">
      <Text className="mb-2 text-2xl font-bold text-ink-900">{t('errors.notFoundShelf')}</Text>
      <Text className="mb-6 text-center text-base text-ink-600">{t('errors.notFoundHint')}</Text>
      <Link
        href="/"
